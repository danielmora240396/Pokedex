...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _model_Search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model/Search */ \"./src/js/model/Search.js\");\n/* harmony import */ var _view_searchView_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view/searchView.js */ \"./src/js/view/searchView.js\");\n!(function webpackMissingModule() { var e = new Error(\"Cannot find module '../model/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\r\n\r\n\r\n\r\nconst state = {};\r\n\r\nconst getPokemonList = async() => {\r\n    try {\r\n        state.pokemon = new _model_Search__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\r\n        await state.pokemon.initialData();\r\n        _view_searchView_js__WEBPACK_IMPORTED_MODULE_1__[\"renderLoader\"]();\r\n        setTimeout(() => {\r\n            _view_searchView_js__WEBPACK_IMPORTED_MODULE_1__[\"clearLoader\"]();\r\n            renderPokemonList();\r\n        }, 3000);\r\n    } catch (error) {\r\n        \r\n    }\r\n    \r\n}\r\n\r\nconst renderPokemonList = (array = state.pokemon.pokemonListDetails) =>{\r\n    document.querySelector(\".result\").innerHTML= \"\";\r\n    for (const iterator of array) {\r\n        _view_searchView_js__WEBPACK_IMPORTED_MODULE_1__[\"renderTiles\"](iterator);\r\n    }\r\n}\r\n\r\nconst filterPokemon = (string) => {\r\n    const data = [];\r\n    for (const iterator of state.pokemon.pokemonListDetails) {\r\n        if (iterator.name.startsWith(string)) {\r\n            data.push(iterator);\r\n        }\r\n    }\r\n    setTimeout(() => {\r\n        _view_searchView_js__WEBPACK_IMPORTED_MODULE_1__[\"clearLoader\"]();\r\n        renderPokemonList(data);\r\n    }, 1000);\r\n}\r\n\r\n\r\nwindow.addEventListener('load', e => {\r\n    getPokemonList();\r\n    console.log(!(function webpackMissingModule() { var e = new Error(\"Cannot find module '../model/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));\r\n\r\n    document.querySelector(!(function webpackMissingModule() { var e = new Error(\"Cannot find module '../model/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).form).addEventListener('submit', e => {\r\n        console.log(e);\r\n        filterPokemon(!(function webpackMissingModule() { var e = new Error(\"Cannot find module '../model/base'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).input.value.trim());\r\n    });\r\n});\r\n\r\n    \r\n\r\n\r\n\r\n\n\n//# sourceURL=webpack:///./src/js/index.js?");
